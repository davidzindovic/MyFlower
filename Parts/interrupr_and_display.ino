...
if(neki==0)tft.fillScreen(ST77XX_BLACK);
else if(neki==1)tft.fillScreen(ST77XX_RED);
else if(neki==2)tft.fillScreen(ST77XX_YELLOW);
else if(neki==3)tft.fillScreen(ST77XX_ORANGE);
else if(neki==4)tft.fillScreen(ST77XX_GREEN);
...
for (int i = 200; i < 256; i++) { // i = 255 = approx 3.3 volts, i = 0 = approx 0.0 volts
